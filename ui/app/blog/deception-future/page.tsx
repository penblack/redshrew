    ...
    <main className="min-h-screen bg-black text-white px-6 py-24 font-sans max-w-3xl mx-auto space-y-12">
      ...
      <article className="space-y-6 text-gray-300 text-base leading-relaxed">
        <p>
          ...
          RedShrew believes in weaponizing perception — forcing adversaries into controlled environments where we hold the advantage.
        </p>
        <p>
          Every trap sprung gives us new intelligence: tools, timing, methods, even their psychology.
          Traditional defenses log signals. We log behavior.
        </p>
        <p>
          As threats evolve, so must defenses. Deception gives us visibility, context, and — most importantly — narrative control.
        </p>
      </article>
    </main>
  );
