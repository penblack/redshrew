    ...
    <footer className="w-full bg-[#180606] text-neutral-300 border-t border-red-900">
      <div className="max-w-7xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          ...
          <span className="text-xs text-neutral-500 ml-2">© {new Date().getFullYear()} RedShrew. All rights reserved.</span>
        </div>
        {/* Center: Links */}
        <nav className="flex flex-wrap items-center gap-x-6 gap-y-2 text-sm">
          <Link href="/privacy" className="hover:text-red-400 transition-colors">Privacy</Link>
          <Link href="/terms" className="hover:text-red-400 transition-colors">Terms</Link>
          ...
          <Link href="/security" className="hover:text-red-400 transition-colors">Security</Link>
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <a
            ...
            aria-label="GitHub"
          >
            {/* Replace with your GitHub icon or keep text */}
            <svg width="22" height="22" viewBox="0 0 24 24" fill="none" className="fill-neutral-400 hover:fill-red-500 transition-colors">
